...
const programImages = [heroImage, communityImage, researchImage];
...
export default function Home() {
  ...
  return <div className="future-shell">
    ...
    <footer className="future-footer"><div className="future-width footer-inner"><div className="footer-future-brand"><img src={emblem} alt="USSRC" loading="lazy" decoding="async" /><span><b>USSRC</b><small>Union of Sudanese Students<br />&amp; Researchers in China</small></span></div><div className="footer-signal">A stronger academic journey,<br /><em>shared.</em></div><div className="footer-end"><span>© {new Date().getFullYear()} USSRC</span><a href="#top">Back to top ↑</a></div></div></footer>
  </div>;
}
